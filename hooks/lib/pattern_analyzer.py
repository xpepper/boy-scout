"""
Reading a source file as comparable lines.

The anchors are the only consumer: an entry's fingerprint is a hash of the
significant lines it points at, so what counts as "significant" and how a line
is normalized decide whether an anchor survives a reformat.
"""
import re
...
def normalize_line(line: str) -> str:
    ...
    # reformatting — `a  =  b` and `a = b` are the same line to the anchors.
